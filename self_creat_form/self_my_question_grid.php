<head>
	...
	<table id="dg" title=""  data-options="url:'../some_json.php?tables=self_my_question&abstract=1',toolbar:'#toolbar',pagination:true,singleSelect:true,nowrap:false ">
		<thead>
			<tr>
			<th data-options="field:'ID', sortable:true ,width:50 ">序号</th><th data-options="field:'my_name', sortable:true ">姓名</th> 
<th data-options="field:'my_age', sortable:true ">年龄</th> 
...
<th data-options="field:'my_note', sortable:true ">备注</th> 
	...
	<div id="toolbar" style="height:auto">
		...
		<a href="self_my_question_export.php?class1=self_my_question" class="easyui-linkbutton" data-options="iconCls:'icon-save',plain:true" >导出</a>
	</div>
<div id="signdlg" class="easyui-dialog" title="请签名" data-options="iconCls:'icon-save'" style="width:650px;height:350px;padding:10px">
            ...
            <button id="saveBtn" class="btn btn-default" onclick="saveSignature('self_my_question');" disabled="disabled">保存</button>&nbsp;&nbsp;&nbsp;
            <!--工具栏 	 -->
</div>
			...
			$('#dg').datagrid({
				...
				onExpandRow: function(index,row){
					...
					ddv.panel({
						border:false,
						cache:true,
						href:'./self_my_question_show_form.php?ID='+row.ID+'&index='+index+'&class1=self_my_question',
						onLoad:function(){
...
window.location.href='self_my_question_edit.php?ID='+ID+'&class1='+class1;
}
	</script>